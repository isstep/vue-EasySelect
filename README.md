# <img src="./public/logo.svg" alt="Logo" width="30"/> [EasySelect](https://EasySelect.vercel.app)
...
- **CartItemList**: Список товаров в корзине с возможностью удаления каждого товара.
